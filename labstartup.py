# labstartup.py - version 1.9 - 14-June 2024
...
#    lsf.write_output( f'Creating next scheduled task to run LabStartup check in {lsf.labcheckinterval} minutes...')
#    lsf.create_labcheck_task()
lsf.write_output( 'LabCheck is disabled. Not creating task. ')
